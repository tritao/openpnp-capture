...
typedef void /*__stdcall*/ (*CALLBACK_ENC_DATA)(int nChannel, PUCHAR pData, UINT nBuffLen, PUCHAR pData2, UINT nBuffLen2, int nFrameType, BOOL bMov);
typedef void /*__stdcall*/ (*CALLBACK_RAW_DATA)(int nChannel, PUCHAR pRawBuffer);
typedef void /*__stdcall*/ (*CALLBACK_RAW_AUDIO)(int nChannel, PUCHAR pRawBuffer);
...
////////////////////////////////打开通道前的综合设置////////////////////////////////
//注册压缩数据处理的回调函数
JVSDK_API	void	__stdcall	JVS_SetCallBack(CALLBACK_ENC_DATA cbEncData, CALLBACK_RAW_DATA cbRawData,CALLBACK_RAW_AUDIO cbRawAudio);
//设置无视频信号时SDK输出的图片
...
JVSDK_API	BOOL	__stdcall	JVS_SetAudioRawOut(int nChannel, BOOL bAudioRawOut);
...
//设置压缩模式
JVSDK_API	void	__stdcall	JVS_SetQualityMode(int nChannel, DWORD dwQualityMode, DWORD dwMBPH, DWORD dwAlgorithm);
...
JVSDK_API	void	__stdcall	JVS_EnableSubStream(int nChannel, BOOL bEnableSubStream);
//获取压缩文件头数据
JVSDK_API	BOOL	__stdcall	JVS_GetHeaderData(int nChannel, PJVS_FILE_HEADER pheaderData);
JVSDK_API	BOOL	__stdcall	JVS_GetHeaderData2(int nChannel, PJVS_FILE_HEADER pheaderData);
...
JVSDK_API	BOOL	__stdcall	JVS_GetBitmapToFile(int nChannel, PUCHAR pCapBmpFile, BOOL bWaitForCap);
...
JVSDK_API	void	__stdcall	JVS_EnablePreviewD1(int nChannel, BOOL bEnableD1);
